...
#NOTE: Condensed working code is located at line 134
...
#import Stan Data
StanData <- read.csv("C:/Users/BAB/Documents/R/FisheRies/Stan data example/Emily code/StanDataClean21Csv.csv", header = TRUE)
...
lines(RiponMin~StanData$Date, type = "l", col = "blue", lwd = 2)
#note that both syntaxes for plotting yield the same line - whatever your preference is (make sure your order is correct)
...
# here is my original title: title(main = "Daily Water Temperatures and Dissolved Oxygen at Ripon for June 2015")
#to get a line return in the title, add \n where you want the new line to be:
title(main = "Daily Water Temperatures and Dissolved Oxygen \n at Ripon for June 2015")
...
#reviewing my code, the margin text for the 4th axis doesn't appear - need to make sure to fix margins!
...
StanData <- read.csv("C:/Users/BAB/Documents/R/FisheRies/Stan data example/Emily code/StanDataClean21Csv.csv", header = TRUE) #imported data
...
#Demo sensitivity to plot window sizing - plot is squished when plot window is small