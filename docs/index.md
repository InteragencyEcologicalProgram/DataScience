...
1:00 - 1:10 &nbsp;&nbsp; Regular Expressions (regex) - it's magic if it works ([Rosemary Hartman](https://www.linkedin.com/in/rosemary-hartman-1b3b53bb/), [DWR](https://water.ca.gov/))  
1:10 - 1:40 &nbsp;&nbsp; Project-oriented workflows and file management in R ([Corey Clatterbuck](https://www.coreyclatterbuck.com/), [SWRCB - OIMA](https://www.waterboards.ca.gov/resources/oima/))  
1:40 - 2:00 &nbsp;&nbsp; Datasheet Hoarding: When do you let go of your physical datasheets? (Tim Malinich, [CDFW](https://wildlife.ca.gov/))  
