---
title: "RMarkdown Demo on GitHub"
author: "Jason DuBois"
...
We can easily include plots for files displayed on GitHub. Just do as you would for any .Rmd file. When you press the `Knit` button, note the addition of a folder in your working directory. This folder is named as <FILE NAME>_files. Open this folder, and you should see another folder "figure-markdown_github". This folder contains the .png file for the plot you just created. You must `push` this folder to GitHub for the figures to be visible in your .md file.
